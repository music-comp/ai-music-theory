# AI Assistant Guide for the Music Theory AI Skill MCP Server Development

**Version:** 2.0
**Last Updated:** 2025-12-31
**Purpose:** Comprehensive guidelines for AI assistants working with the the Music Theory AI Skill MCP Server project

## About This Document

This document provides essential guidance for AI assistants (like Claude Code) when working with the mcp-server codebase. It focuses on Rust guidelines for general best practices.
...
**Important:** If `assets/ai/ai-rust` does not exist on the file system, check to make sure you have determined if it is a sym link. If that doesn't exist, ask permission to clone it:
