...
## To Identify:
1. Locate a passage where an authentic cadence seems imminent
2. Determine what prevents the cadence from occurring
3. Classify: Was the tonic replaced (deceptive)? Did a new beginning start (evaded)? Was the dominant problematic (abandoned)?

# Context & Application
Cadential deviations arise infrequently in simple main themes but appear much more regularly in subordinate themes and loosely organized sections. They are a primary means of extending themes beyond their normative length.

# Examples
**Example 1** (p. 152): Mozart, K. 310, iii -- deceptive cadence (V resolves to VI) extends consequent.
**Example 2** (p. 153): Evaded cadence at m. 10, music "backs up" to m. 7 material.
...
- **Error**: Applying cadential deviation labels to half cadences
  **Correction**: Cadential deviations apply only to implied authentic cadences

# Common Confusions
- **Confusion**: Not distinguishing between deceptive and evaded cadences
  **Clarification**: The critical distinction is grouping structure: in deceptive cadences, the replacement harmony groups backwards; in evaded cadences, the new material groups forward
