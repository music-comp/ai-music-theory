---
concept: Framing Functions
slug: framing-functions
...
## To Identify:
1. Look for material before the first basic idea -- is it introductory?
2. Look for material after the cadence -- is it postcadential?
3. Check the dynamic quality: progressive (building) or recessive (dying away)?

# Context & Application
Framing functions affect the overall length of a theme without being part of its core phrase structure. They are common in the classical repertory and help establish mood, prepare the listener, or wind down energy after a cadence.

# Examples
**Example 1** (p. 156): Beethoven, Sonata Op. 22, ii, mm. 1-12 -- 1-m. thematic introduction ("vamp" in left hand) precedes the theme; closing section follows PAC at m. 9.
...
- **Error**: Counting framing functions as part of the theme's measure structure
  **Correction**: Framing functions are external; the theme's measures begin with the basic idea

# Common Confusions
- **Confusion**: Confusing thematic introduction with "slow introduction" (Ch. 16)
