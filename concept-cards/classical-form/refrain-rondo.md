...
- Complete refrain: full original structure preserved
- Abridged refrain: only the A (or A') section of an original ternary, still ending with a PAC
- Incomplete refrain: lacks cadential closure or cadences in a different tonal region
...
# Examples
- Mozart, Piano Sonata in C, K. 545, iii: Simple period as refrain
