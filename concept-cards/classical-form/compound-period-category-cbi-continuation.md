...
# Examples
- Mozart, Piano Concerto in A, K. 488, i, mm. 1-16: c.b.i. over tonic prolongation; continuation phrases in antecedent and consequent exhibit diverse melodic content; "plagal" appearance at end of first phrase is actually tonic prolongation embellished by subdominant
- Haydn, String Quartet in C, Op. 74/1, i, mm. 3-18: c.b.i. over tonic pedal; consequent significantly altered — continuation => cadential begins at m. 13 with expanded cadential progression spanning six measures; antecedent's four-measure continuation is expanded to six measures in the consequent
...
# Common Confusions
- An apparent "plagal cadence" (IV-I) at the end of the c.b.i. is usually just a subdominant embellishing a tonic prolongation — it does not constitute a genuine cadence
- The two continuation phrases need not be identical in melodic content — what must be preserved is the functional pattern (c.b.i. + continuation in both halves)
- The consequent may significantly alter the proportions of its internal phrases (e.g., shorter c.b.i. and longer continuation) while preserving the essential formal logic

# Source Reference
Chapter 5: Hybrid Themes and Compound Themes, "Sixteen-Measure Period — Antecedent = compound basic idea + continuation" section (PDF page 70)
