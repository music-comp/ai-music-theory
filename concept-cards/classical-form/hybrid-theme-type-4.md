...
4. The return of the basic idea is what makes the second phrase a consequent
...
# Examples
- Beethoven, String Quartet in G, Op. 18/2, iv, mm. 21-28: compound basic idea (no harmonic motion into m. 24 prohibits any cadence); consequent brings back the basic idea (now with dominant harmony) and closes with emphatic PAC
- Haydn, Symphony No. 87 in A, iii, mm. 1-8: tonic prolongation extends through m. 7 of the theme, with the cadential progression compressed into the final measures
...
# Common Confusions
- Hybrid type 4 vs. period: the only difference is the absence of a cadence at m. 4 — if a cadence is present, it is a period; if not, it is hybrid type 4
- The consequent phrase of hybrid type 4 may have continuational qualities (harmonic acceleration relative to the c.b.i.) — this does not change its consequent identity, which is established by the return of the basic idea
- Hybrid type 4 is not used in sixteen-measure periods because the basic idea would appear at both m. 5 and m. 9, spoiling the effect of the higher-level consequent

# Source Reference
Chapter 5: Hybrid Themes and Compound Themes, "Hybrid 4: compound basic idea + consequent" section (PDF page 70)
