...
# Examples
- Beethoven, Piano Sonata in A-flat, Op. 26, i, mm. 1-16: model form; four-measure antecedent followed by continuation with fragmentation into two-beat units, harmonic acceleration, and second HC at m. 8; basic idea returns at m. 9 for the large-scale consequent
- Haydn, Symphony No. 93 in D, iv, mm. 1-16: opens with c.b.i. over tonic pedal; mm. 5-8 bring material resembling the basic idea but with different harmonies (continuation function); true restatement with original harmonization at m. 9 marks the higher-level consequent
...
# Common Confusions
- This is NOT a "double period" — the lower level uses hybrid structure (antecedent + continuation), not periodic structure (antecedent + consequent)
- When material at m. 5 resembles the basic idea, check the harmonization — different harmonies confirm continuation function; the true consequent (with original harmonization) begins at m. 9
- The two weak cadences (at mm. 4 and 8) serve different hierarchical functions: the first closes the lower-level antecedent; the second closes the large-scale antecedent unit

# Source Reference
Chapter 5: Hybrid Themes and Compound Themes, "Sixteen-Measure Period — Antecedent = antecedent + continuation" section (PDF page 70)
