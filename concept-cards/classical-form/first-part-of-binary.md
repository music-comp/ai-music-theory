...
4. HC ending strongly suggests binary (not ternary) interpretation
5. May remain in home key or modulate
...
# Examples
- Haydn, Piano Sonata in E, Hob. XVI:31, iii, mm. 1-8 (regular antecedent followed by modulating phrase ending with HC -- "failed consequent")
- Beethoven, Violin Sonata in A, Op. 30/1, iii, mm. 1-8 (compound basic idea followed by HC-ending phrase; nonconventional periodic qualities)
- Haydn, Piano Trio in A-flat, Hob. XV:14, ii, mm. 1-8 (sentence ending with PAC)
- Beethoven, String Quartet in C-sharp Minor, Op. 131, iv, mm. 1-16 (sentence ending with HC)
...
# Common Confusions
- A first part ending with PAC is indistinguishable from a small-ternary exposition until the second part is heard
- A first part ending with HC does NOT automatically make the theme a binary -- it merely makes a ternary interpretation unlikely
- A "failed consequent" (phrase that begins like a consequent but ends with HC instead of PAC) is a nonconventional form, not a true antecedent (since a true antecedent is nonmodulatory)
- The repetition of the first part via repeat signs is not the same as a consequent answering an antecedent
