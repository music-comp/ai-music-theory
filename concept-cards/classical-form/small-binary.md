...
4. Second part usually begins with material related to the first part's opening
5. First part may end with HC (unlike small ternary, whose A section rarely ends with HC)
6. Second part always concludes with PAC in the home key
...
# Examples
- Haydn, Piano Sonata in E, Hob. XVI:31, iii, mm. 1-16 (antecedent + failed consequent as first part; model-sequence in second part)
- Beethoven, Violin Sonata in A, Op. 30/1, iii, mm. 1-32 (compound basic idea opening; nonconventional periodic qualities)
- Haydn, Piano Trio in A-flat, Hob. XV:14, ii, mm. 1-16 (sentence as first part; contrasting middle + continuation in second part)
- Beethoven, String Quartet in C-sharp Minor, Op. 131, iv, mm. 1-32 (sentential first and second parts)
- Beethoven, Fifteen Variations, Op. 35, mm. 66-81 (contrasting middle + cadential in second part)
...
# Common Confusions
- Do not confuse with rounded binary (small ternary) -- the key distinction is the ABSENCE of recapitulation in the small binary
- When the first part ends with a PAC, the small binary cannot be distinguished from a small ternary until the second part fails to recapitulate the basic idea
- When the first part ends with a HC, a period interpretation may be implied but fails when the second phrase also ends with a HC
- The motivic connection between part openings is a tendency, not a requirement; some small binaries begin the second part with contrasting material

# Source Reference
Chapter 7: Small Binary, pp. 87-93 (PDF page 98)
