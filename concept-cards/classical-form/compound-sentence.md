...
4. Cadential progression usually expanded to fill final four measures
...
# Examples
- Beethoven, Piano Concerto No. 3 in C Minor, Op. 37, i, mm. 1-16: model form; presentation with statement-response repetition of c.b.i.; continuation develops second motive with fragmentation, harmonic acceleration, and descending third sequential progression
- Haydn, String Quartet in G, Op. 77/1, i, mm. 1-14: compressed continuation; fragmentation jumps from four-measure to one-measure units (4:1 ratio); descending third sequence underlies the fragmentation
- Mozart, Clarinet Trio in E-flat, K. 498, i, mm. 1-16: compressed continuation => cadential with DC at m. 12, motivating repetition of the phrase to achieve PAC
- Haydn, Symphony No. 83 in G Minor ("The Hen"), i, mm. 1-16: compressed continuation with HC at m. 12, followed by four-measure standing on the dominant to restore sixteen-measure length
...
# Common Confusions
- The compound sentence's presentation contains a *compound basic idea* and its repetition, not a simple basic idea — the c.b.i. itself has internal structure (basic idea + contrasting idea)
- Compressed continuation does not mean the sentence is shorter than sixteen measures — repetition, extension, or standing on the dominant typically restores the normative length
- Do not confuse the compound sentence's 8+8 structure with a compound period's 8+8 — in the sentence, the second half is a continuation (no return of basic idea at m. 9); in the period, it is a consequent (basic idea returns at m. 9)

# Source Reference
Chapter 5: Hybrid Themes and Compound Themes, "Compound Themes — Sixteen-Measure Sentence" section (PDF page 70)
