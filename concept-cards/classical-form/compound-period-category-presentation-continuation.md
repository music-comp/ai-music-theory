...
# Examples
- Beethoven, Piano Concerto No. 2 in B-flat, Op. 19, iii, mm. 1-17: both antecedent and consequent display standard sentential characteristics (statement-response, fragmentation, harmonic acceleration, model-sequence); consequent's cadence slightly expanded for the final tonic to fall on a strong beat
- Beethoven, Piano Sonata in C Minor, Op. 10/1, ii, mm. 1-16: antecedent has regular presentation + continuation; consequent alters the continuation to be supported by a single expanded cadential progression (continuation => cadential); the antecedent's brief HC progression is expanded to four measures in the consequent
...
# Common Confusions
- Do not confuse this with two independent sentences that happen to be adjacent — the cadential differentiation (weak then strong) is what binds them into a periodic structure
- The consequent's cadential expansion relative to the antecedent is analogous to the expanded contrasting idea in a simple period's consequent

# Source Reference
Chapter 5: Hybrid Themes and Compound Themes, "Sixteen-Measure Period — Antecedent = presentation + continuation" section (PDF page 70)
