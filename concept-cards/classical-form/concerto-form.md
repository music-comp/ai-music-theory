...
- Subordinate-key ritornello: orchestra alone in subordinate key
- Solo development: functions like a sonata development
- Solo recapitulation: resolves tonal conflict, draws from both earlier "expositions"
...
# Examples
- Mozart, Piano Concerto in E-flat, K. 482, i: Exemplifies all six sections with clear ritornello structure
...
- The closing ritornello is not a coda; it differs from a genuine coda in its use of material, lack of loosening devices, and emphasis on matching closing sections rather than main-theme circularity.
