...
4. Represents the structural goal of the entire exposition
5. Must be a PERFECT authentic cadence (IAC does not suffice)
...
# Examples
- Every properly constructed subordinate theme ends with an EEC
- Mozart, Piano Sonata in C, K. 545, i, m. 28 (PAC in G major confirms the subordinate key)
- Beethoven, Overture to Coriolanus, Op. 62, m. 102 (PAC in G minor after extensive modulating subordinate theme with internal HC, abandoned cadences, and IAC extension)
- Mozart, Violin Concerto in A, K. 219, i, m. 98 (PAC in E major after multiple evaded cadences)

# Related Concepts
- Subordinate Theme
- Cadential Extension
- Evaded Cadence
- Closing Section in Subordinate Theme
- Subordinate Key
- Exposition

# Common Confusions
- The EEC must be a PAC, not an IAC or HC -- an IAC signals that the theme is NOT yet finished
- The EEC is the cadence of the SUBORDINATE THEME, not the closing section -- the closing section follows postcadentially
- In a subordinate-theme group, the EEC is the final PAC of the last theme in the group
- The EEC has a counterpart in the recapitulation: the essential structural closure (ESC), which confirms the home key

# Source Reference
Chapter 8: Subordinate Theme, throughout chapter; concept implied by the requirement that subordinate themes end with PAC in the subordinate key (PDF page 108)
