...
2. **Antecedent = compound basic idea + continuation** (two hybrid type 3s): c.b.i. as first half of each eight-measure unit, followed by continuation
3. **Antecedent = antecedent + continuation** (two hybrid type 1s): four-measure antecedent + four-measure continuation in each eight-measure unit

Key structural rules:
- A four-measure consequent is NOT normally found within a sixteen-measure period
...
# Examples
- Beethoven, Piano Concerto No. 2 in B-flat, Op. 19, iii, mm. 1-17: antecedent = presentation + continuation (two sentences); statement-response in presentation, fragmentation and harmonic acceleration in continuation
- Beethoven, Piano Sonata in A-flat, Op. 26, i, mm. 1-16: antecedent = antecedent + continuation (hybrid type 1); basic idea returns at m. 9 for large-scale consequent
- Mozart, Piano Concerto in A, K. 488, i, mm. 1-16: antecedent = c.b.i. + continuation
- Haydn, String Quartet in C, Op. 74/1, i, mm. 3-18: antecedent = c.b.i. + continuation => cadential; consequent significantly altered with expanded cadential progression
...
# Common Confusions
- A "double period" (antecedent + consequent at both levels) is avoided by classical composers because the basic idea would appear at both m. 5 and m. 9, undermining the impact of the higher-level consequent
- Hybrid type 4 (c.b.i. + consequent) is also avoided in compound periods for the same reason
- The consequent unit may be significantly altered relative to the antecedent unit — especially the cadential function, which is often greatly expanded
- The consequent's cadential expansion in a compound period is analogous to the expanded contrasting idea of a simple period's consequent

# Source Reference
Chapter 5: Hybrid Themes and Compound Themes, "Compound Themes — Sixteen-Measure Period" section (PDF page 70)
