...
3. Common causes of asymmetry:
   - Interpolation within the consequent
   - Deceptive cadence motivating extension/repetition of cadential material
...
- A deceptive cadence extending the consequent is different from an expanded consequent — extension adds material *after* the structural point of expected closure; expansion enlarges the phrase *before* that point
