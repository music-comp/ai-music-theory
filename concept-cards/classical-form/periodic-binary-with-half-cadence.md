...
4. The second phrase is a "failed consequent" -- not a true antecedent (since it may modulate)
5. When the first part is repeated, a 16-measure period is initially implied
...
# Examples
- Haydn, Piano Sonata in E, Hob. XVI:31, iii, mm. 1-16 (antecedent followed by modulating phrase ending with HC -- "failed consequent"; second part brings model-sequence continuation)
- Beethoven, Violin Sonata in A, Op. 30/1, iii, mm. 1-32 (compound basic idea followed by HC-ending phrase; "reversed period" suggested -- consequent followed by antecedent; second phrase opens melodic space further than first)
...
- Half Cadence
- Failed Consequent
- Nonconventional Form

# Common Confusions
- A "failed consequent" is NOT a true antecedent -- a true antecedent is nonmodulatory and implies a subsequent consequent
- The period-like cadential pattern (HC then PAC) across both parts does NOT make the overall form a period; too many other characteristics of periodic organization are lacking
- The repetition of the first part does not create a consequent -- when both repetitions end with HC, the consequent function remains unrealized
- A "reversed period" (consequent then antecedent) is an analytical description of the cadential pattern, not a functional label

# Source Reference
Chapter 7: Small Binary, "First Part" section, pp. 88-89 (PDF page 98)
