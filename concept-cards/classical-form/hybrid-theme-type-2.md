...
4. Little or no harmonic acceleration — harmonic rhythm may actually slow
...
# Examples
- Beethoven, Violin Sonata in D, Op. 12/1, iii, mm. 1-8: antecedent with HC at m. 4; second phrase brings new material over E.C.P. with no fragmentation and no harmonic acceleration — exclusively cadential
- Haydn, String Quartet in G, Op. 64/4, ii, mm. 1-8: sentential antecedent (basic idea with one-measure statement-response); cadential second phrase with new two-measure melody, no fragmentation, diminished harmonic rhythm
...
# Common Confusions
- The same phrase type (E.C.P.-based) is labeled differently depending on context: "continuation => cadential" after a presentation (sentence context); "cadential" after an antecedent (hybrid context) — this distinction matters for understanding the formal logic
- Do not look for continuational features that are not there — the lack of fragmentation and acceleration is precisely what makes this an exclusively cadential phrase
- Hybrid type 2 is NOT a period — the basic idea does not return in the second phrase

# Source Reference
Chapter 5: Hybrid Themes and Compound Themes, "Hybrid 2: antecedent + cadential" section (PDF page 70)
