...
# Examples
- Mozart, Piano Sonata in C, K. 330/300h, ii, mm. 1-8: standard antecedent with HC, followed by continuation with fragmentation into one-measure units and modulation to dominant
- Beethoven, Symphony No. 2 in D, Op. 36, ii, mm. 1-8: antecedent followed by continuation; no fragmentation, but increased harmonic rhythm and more active bass line express continuation function
...
# Common Confusions
- The second phrase is a continuation, not a consequent — if the basic idea returned, it would be a period; its absence is what makes this a hybrid
- An antecedent can exist without a consequent — it is not "incomplete" or "wrong" to have an antecedent followed by continuation
- Not every combination of phrases is syntactically valid — a consequent followed by a presentation, for example, would be functionally illogical

# Source Reference
Chapter 5: Hybrid Themes and Compound Themes, "Hybrid 1: antecedent + continuation" section (PDF page 70)
