...
4. **Second phrase (mm. 5-8)**: continuation — fragmentation, harmonic acceleration, cadential closure
...
# Examples
- Haydn, Piano Sonata in C, Hob. XVI:35, i, mm. 1-8: opening phrase looks like an antecedent but the dominant at m. 4 supports the entire contrasting idea from m. 3, creating a single I-V7 tonic prolongation with no cadence; continuation follows with fragmentation, harmonic acceleration, and PAC
- Haydn, Symphony No. 95 in C Minor, iii, mm. 1-8: tonic pedal throughout the c.b.i. destroys any cadential potential; continuation => cadential follows with E.C.P. and harmonic acceleration
...
# Common Confusions
- The crucial distinction between an antecedent and a compound basic idea is the **cadence** — if the first phrase ends with a cadence, it is an antecedent (hybrid type 1 or period); if not, it is a compound basic idea (hybrid type 3 or 4)
- A dominant chord at the end of mm. 3-4 does not automatically create a HC — check whether it is the goal of a cadential *progression* or merely part of a tonic *prolongation*
- The compound basic idea looks like an antecedent but functions like a presentation harmonically
