...
- Requires crossing to a new diminished seventh core
- Zones shift (e.g., from 3-1 range to 5-3 range)
- Motion becomes directed (upshift or downshift)

Markers of interregional modulation:
- New pitch-class spoiler from different diminished seventh collection
