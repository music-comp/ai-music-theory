#!/usr/bin/env python3
"""
Update image references in complete-muscician book.md file
...
# File path (note: directory has typo "muscician")
BOOK_FILE = Path("sources-md/complete-muscician/book.md")
